...
const ProductDetail = () => {
  ...
  const product = products.find((product) => product.title.toLowerCase() === slug);
  ...
  <div className="h-screen display:flex justify-center items-center  ">
      ...
      <div className="product-image">
        <img className=" rounded-2xl" src={product?.img} alt="product-image" />
      </div>
                        {/* ------slider-image------  */}
      ...
      <div className="product-details p-5">
        <h1 className="product-title mb-5 font-bold border-b-2">{product?.title}</h1> 
